...
for(int i = 0; i<name.length();i++) {
   ...
   System.out.println("name.length"+name.length()+"namecode"+nameCode+"gender"+gender+"today:"+today+"fortune길이"+fortune.length);
